        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              >
                <div className="text-[#2E4A8A] bg-[#557cd827] rounded-3xl flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary transition-transform duration-300 group-hover:scale-110">
                  <Github size={14} />
                </div>
